...
Battery_Dataframe_partial = pd.read_csv('Battery_Dataframe_R2.csv')
Battery_Dataframe_full = pd.read_csv('Battery_Dataframe_full_R2.csv')

Ladung_Dataframe0 = pd.read_csv('R2_Simulink.csv')
Ladung_Dataframe1 = pd.read_csv('R2_Simulink_full.csv')

Time = Battery_Dataframe_partial['Zeit [s]']
Ladung_Dataframe_Simulink0 = Ladung_Dataframe0['R2']
Ladung_Dataframe_Python0 = Battery_Dataframe_partial['R2 [Ohm]']
...
Ladung_Dataframe_Simulink1 = Ladung_Dataframe1['R2']
Ladung_Dataframe_Python1 = Battery_Dataframe_full['R2 [Ohm]']
